...
const SUPERIA_PARAMS: FilterParams = {
  ...
  shadows: 10,
  blackLevel: 4,
  splitToneHighlight: { color: '#FFF3D6', amount: 0.04 },
  splitToneShadow: { color: '#5C8A6E', amount: 0.1 },
  grainAmount: 10,
  grainSize: 1.0,
  halationThreshold: 0.85,
  halationRadius: 3,
...
const CINESTILL_PARAMS: FilterParams = {
  ...
  shadows: -5,
  blackLevel: 2,
  splitToneHighlight: { color: '#BFE0FF', amount: 0.08 },
  splitToneShadow: { color: '#1A2A4A', amount: 0.1 },
  grainAmount: 15,
  grainSize: 1.4,
